...
def run_spark_job(spark):
    ...
    # Code based on Spark integration guide here:
    # https://spark.apache.org/docs/latest/structured-streaming-kafka-integration.html
    # Can bot set custom schema as per the doc (the topic schema is immutable)
    df = spark \
            .readStream \
            .format("kafka") \
            .option("kafka.bootstrap.servers", "localhost:9092") \
            .option("subscribe", "com.udacity.crime.sf.stats.v1") \
    ...
    kdf = df.selectExpr("CAST(value AS STRING)")
